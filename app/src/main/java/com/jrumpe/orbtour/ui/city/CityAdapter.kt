package com.jrumpe.orbtour.ui.city
...
class CityAdapter(val context: Context, var cityList: ArrayList<City>) :
    ...
    inner class CityViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView),
        ...
        private val icFavoriteBorderedImage = ResourcesCompat.getDrawable(context.resources,
            R.drawable.ic_favorite_border, null)
        ...
        fun deleteItem() {
            ...
            notifyItemRemoved(currentPosition)      //   index of the items is only updated internally
            notifyItemRangeChanged(currentPosition,
                cityList.size)      // update viewholder objects  from current position to new size of city list object.
